...
class LagrangianTD3(trainer.Algorithm):
    ...
    def __init__(self, state_shape, action_shape, device=torch.device('cuda'), seed=0,
        ...
        self.tau = tau
        self.policy_noise = policy_noise # TD3 param
        self.noise_clip = noise_clip # TD3 param
        self.policy_freq = policy_freq # TD3 param
    ...
    def update_reward_critic(self, states, actions, rewards, dones, next_states):
        curr_qs1, curr_qs2 = self.reward_critic(states, actions) # Double Q-learning
