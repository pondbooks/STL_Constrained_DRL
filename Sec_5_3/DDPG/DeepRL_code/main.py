...
def main():
    ...
    algo = lagrangian_ddpg.LagrangianDDPG(
    ...
    Lagrangian_DDPG_trainer = trainer.Trainer(
        env=env,
        env_test=env_test,
        algo=algo,
        seed=SEED,
    ...
    Lagrangian_DDPG_trainer.train() # training
    Lagrangian_DDPG_trainer.save_result() # saving result
